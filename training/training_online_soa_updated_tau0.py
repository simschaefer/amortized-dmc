...
from dmc import DMCsoa

num_batches_per_epoch = 250

#########
network_name = "dmc_sdr_estimated_4afc_soa_settrans_updated_tau0_" + str(epochs) + '_' + slurm_id 
######### 
...
model_specs = {"simulation_settings": {"prior_means": np.array([30.3, 273.28, 0.715, 454.37, 108, 33.54]),
                                       ...
                                       "soa": 166,
                                       'param_lower_bound' : np.array([0,0,0,0,0,0]),
                                       "fixed_num_obs": None,
...
simulator = DMCsoa(**model_specs['simulation_settings'])
